...
import wolox.albums.clients.*;
import wolox.albums.models.*;
...
public class SharedAlbumServiceTests {
	...
	public void testFindAllSharedAlbums(){
		...
		Assert.assertEquals(2, albums.size(), 0); // Son 2 porque se guardaron registros sobre los albums con id 1 y 2.
	}
